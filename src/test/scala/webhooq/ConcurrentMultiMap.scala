...
// Thanks Victor! (https://github.com/akka/akka/blob/release-1.3.1/akka-actor/src/main/scala/akka/actor/ActorRegistry.scala)
/**
...
class ConcurrentMultiMap[K <: AnyRef, V <: AnyRef: Manifest] {
  ...
  def values(key: K): Array[V] = {
    val set: java.util.Set[V] = container get key
